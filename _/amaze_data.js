{
    "gameinfo": {
        ...
        "accessibility": "<h1>Accessibility</h1><div class='message'><p>The Accessibility Maze has been designed to be accessible to screen readers. <ul><li>Play the game using NVDA with Firefox or using ChromeVox with the Chrome web browser.</li><li>Or, use JAWS 2020+ with the current Chrome of Firefox web browser.</li><li>Disable background music using the Audio button above the maze.</li><li>The second button above the maze returns you to the game menu.</li><li>Listen for screen reader shortcuts during game play.</li><li>Navigate slowly to hear all status messages.</ul></div>",
