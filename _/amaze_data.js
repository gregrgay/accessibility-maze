{
    "gameinfo": {
        ...
        "howto": "<h1>How to Play</h1><div class='message'><p>The goal of the Accessibility Maze is to navigate through the maze, solving puzzles to advance and collecting gems to be exchanged for a reward after completing the game.</p><ul><li>Best played with current versions of Chrome, Firefox or Safari.</li><li>Once in the maze use your keyboard's arrow keys to move up and down, or left and right, through the squares in the maze.</li><li>Press the arrow keys while next to an object to bump up against the object and activate it.</li><li>Use the Escape (Esc) key to dismiss any dialog boxes, puzzles, or diary pages after reading their content.</li><li>Your position in the game is maintained when returning to the menu, so you can continue where you left off in the game by clicking Resume Saved. Choosing New Game will start the game over from the beginning.\n</li></div>",
