...
app.config(['$routeProvider', '$locationProvider', 
	...
	function($rootScope, $http, $location, $storage, $route, $interval, $timeout) {
		...
		$rootScope.warnMobileAndTabletUsers = function() {
			var check = false;
			...
			if (check) {
				alert("This game requires the use of a physical keyboard. Please try it on you desktop or laptop computer.", "Warning");
			}
		};
	...
	function($rootScope, $scope, $location, $storage, $route, $timeout) {
		...
		if (!$rootScope.assetsLoaded) {
			...
			if ($rootScope.game.firstTime) {
				$scope.message = "<h1>How to Play</h1><ul><li>Use KEYBOARD to play the game:<ul><li>Arrow keys &mdash; move around</li><li>Enter key &mdash; press buttons</li><li>Esc key &mdash; close popup boxes (including this one)</li></ul></li><li>Bump into things to interact</li><li>Pay attention to status messages below the map</li></ul>"
